  ...
  <el-container>
    ...
    <el-aside :width="asideWidth" class="aside">
      ...
      <el-scrollbar style="height: calc(100vh - 55px);">
        ...
        default-active="/teacher/examManagement">
          <el-sub-menu >
            <template v-slot:title>
              <el-icon><Document /></el-icon>
              <span>考试管理</span>
            </template>
            <el-menu-item index="/teacher/examManagement">
              <el-icon><Search/></el-icon>
              <span>查看考试</span>
            </el-menu-item>
            <el-menu-item index="/teacher/createExam">
              <el-icon><Setting/></el-icon>
              <span>创建考试</span>
            </el-menu-item>
            <el-menu-item index="/teacher/examAnalysis" >
              <el-icon><Setting/></el-icon>
              <span>成绩分析</span>
            </el-menu-item>
          ...
          <el-sub-menu>
            ...
            <el-menu-item index="/teacher/questionManagement">
              <el-icon><Search/></el-icon>
              <span>查看题库</span>
            </el-menu-item>
            <el-menu-item index="/teacher/createQuestion">
              <el-icon><Setting/></el-icon>
              <span>创建题目</span>
            </el-menu-item>
          </el-sub-menu>
